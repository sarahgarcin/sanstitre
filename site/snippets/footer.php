  ...
  <?php echo js('assets/bower_components/isotope/dist/isotope.pkgd.min.js') ?>
  <?php echo js('assets/bower_components/isotope-horizontal/horizontal.js') ?>
  <?php //echo js('assets/bower_components/jquery-rotate/jquery.rotate.js') ?>
